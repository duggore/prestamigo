<?php include 'conf/agregarmicrofilmheader.php' ?>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Agregar microfilm</h3>
...
if(isset($_POST['submit'])){
    ...
    if(empty($nombre) or empty($categoria)){
        ...
        mysql_query("INSERT INTO microfilms VALUES ('','$nombre','$categoria','$etiqueta','$estado')");
        echo '<script language="javascript">';
        echo 'alert("¡Microfilm registrado correctamente!")';
        echo '</script>';
    }
}
