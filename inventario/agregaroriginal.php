<?php include 'conf/agregaroriginalheader.php' ?>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Agregar documento original</h3>
                      ...
                      <?php 
                            if(isset($_POST['submit'])){
                                ...
                                if(empty($nombre) or empty($categoria)){
                                    ...
                                    mysql_query("INSERT INTO originales VALUES ('','$nombre','$categoria','$etiqueta','$estado')");
                                    echo '<script language="javascript">';
                                    echo 'alert("¡Documento original registrado correctamente!")';
                                    echo '</script>';
                                }
                            }
