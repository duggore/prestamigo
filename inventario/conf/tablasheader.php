              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <?php 
                      if($user_level == 1){
                        ...
                        echo '<li>';
                          echo '<a href="agregaroriginal.php">';
                            echo '<i class="fa fa-book"></i>';
                            echo '<span>Agregar documento</br>original </span>';
                          echo '</a>';
                        echo '</li>';

                        echo '<li>';
                          echo '<a href="agregardigital.php">';
                            echo '<i class="fa fa-book"></i>';
                            echo '<span>Agregar documento</br>digital</span>';
                          echo '</a>';
                        echo '</li>';

                        echo '<li>';
                          echo '<a href="agregarmicrofilm.php">';
                            echo '<i class="fa fa-book"></i>';
                            echo '<span>Agregar microfilm</span>';
                          echo '</a>';
                        echo '</li>';
